        ...
        var l = {
          ...
          d = (function (e) {
            function t(e) {
              var n = this;
              a(this, t),
                r(Object.getPrototypeOf(t.prototype), "constructor", this).call(
                  this,
                  e,
                ),
                (this.state = {
                ...
                (this.onChangeInputCurveDefinition =
                  this.onChangeInputCurveDefinition.bind(this)),
              ...
              var o = function (e) {
                c(o),
                  n.setState({
                    progress:
                      ((e / 4e3) % 1) *
                      document.getElementById("showProgressMovement").checked,
                  });
              };
              c(o);
            }
              ...
              n(t, {
                ...
                onChangeInputCurveDefinition: {
                  value: function (e) {
                    this.setState({
                      value: document
                        .getElementById("inputCurveDefinition")
                        .value.split(",")
                        .map(Number),
                    });
                  },
                ...
                onClickExampleCurve: {
                  value: function (e) {
                    document.getElementById("inputCurveDefinition").value =
                    ...
                    return i.createElement(
                      ...
                      i.createElement(
                        ...
                        i.createElement(
                          "code",
                          null,
                          this.state.progress.toFixed(2).substring(2, 4),
                          "%",
                        ),
                      ),
                          ...
                          i.createElement(
                            ...
                            i.createElement(
                              "text",
                              {
                                ...
                                onClick: this.onClickExampleCurve,
                              },
    ...
    3: [
      function (e, t) {
        for (
          ...
          (i = r[o[c] + "Request" + a]),
            (s = r[o[c] + "Cancel" + a] || r[o[c] + "CancelRequest" + a]);
        if (!i || !s) {
          u = !1;
          var l = 0,
            p = 0,
      ...
      function (e, t, n) {
        !(function (e) {
          ...
          function e(e, t, c, l) {
            ...
            function E(t) {
              for (var n = 0, o = 1, a = i - 1; o != a && _[o] <= t; ++o)
                n += s;
              --o;
            ...
            u = {
              ...
              processUpdates: function (e, t) {
                for (var u, c = null, l = null, p = 0; p < e.length; p++)
                  if (
                    ((u = e[p]),
                    u.type === a.MOVE_EXISTING || u.type === a.REMOVE_NODE)
                  ) {
                    var d = u.fromIndex,
            ...
            a = {
              ...
              injectDOMPropertyConfig: function (e) {
                ...
                for (var l in t) {
                  "production" !== n.env.NODE_ENV
                    ? o(
                        !s.isStandardName.hasOwnProperty(l),
                  ...
                  var p = l.toLowerCase();
                  if (
                    ((s.getPossibleStandardName[p] = l), i.hasOwnProperty(l))
                  ) {
                    var d = i[l];
                    (s.getPossibleStandardName[d] = l),
                      (s.getAttributeName[l] = d);
                  } else s.getAttributeName[l] = p;
                  (s.getPropertyName[l] = u.hasOwnProperty(l) ? u[l] : l),
                    (s.getMutationMethod[l] = c.hasOwnProperty(l)
                      ? c[l]
                      : null);
                  var f = t[l];
                  (s.mustUseAttribute[l] = r(f, a.MUST_USE_ATTRIBUTE)),
                    (s.mustUseProperty[l] = r(f, a.MUST_USE_PROPERTY)),
                    (s.hasSideEffects[l] = r(f, a.HAS_SIDE_EFFECTS)),
                    (s.hasBooleanValue[l] = r(f, a.HAS_BOOLEAN_VALUE)),
                    (s.hasNumericValue[l] = r(f, a.HAS_NUMERIC_VALUE)),
                    ...
                    "production" !== n.env.NODE_ENV
                      ? o(
                          !s.mustUseAttribute[l] || !s.mustUseProperty[l],
                    ...
                    "production" !== n.env.NODE_ENV
                      ? o(
                          s.mustUseProperty[l] || !s.hasSideEffects[l],
            ...
            createMarkupForProperty: function (e, t) {
              ...
              return o.isCustomAttribute(e)
                ? null == t
                  ? ""
                  : e + "=" + a(t)
                : ("production" !== n.env.NODE_ENV && c(e), null);
            },
            setValueForProperty: function (e, t, a) {
              if (o.isStandardName.hasOwnProperty(t) && o.isStandardName[t]) {
                ...
                if (i) i(e, a);
                  ...
                  e.setAttribute(o.getAttributeName[t], "" + a);
                else {
            ...
            p = {
              dangerouslyRenderMarkup: function (e) {
                ...
                for (var t, p = {}, d = 0; d < e.length; d++)
                  "production" !== n.env.NODE_ENV
                    ? u(e[d], "dangerouslyRenderMarkup(...): Missing markup.")
                    : u(e[d]),
                    (t = r(e[d])),
                    (t = s(t) ? t : "*"),
                    (p[t] = p[t] || []),
          ...
          "production" !== n.env.NODE_ENV &&
            (f = function (e) {
              var t = e._dispatchListeners,
                ...
                s = o ? t.length : t ? 1 : 0;
              "production" !== n.env.NODE_ENV
                ? v(a === o && i === s, "EventPluginUtils: Invalid `event`.")
                : v(a === o && i === s);
            });
          var g = {
            isEndish: r,
        ...
        (function (n) {
          ...
          function o(e, t, o) {
            ...
            var a = t ? v.bubbled : v.captured,
              i = r(e, o, a);
            i &&
              ((o._dispatchListeners = f(o._dispatchListeners, i)),
          ...
          function i(e, t, n) {
            if (n && n.dispatchConfig.registrationName) {
              var r = n.dispatchConfig.registrationName,
                o = m(e, r);
              o &&
                ((n._dispatchListeners = f(n._dispatchListeners, o)),
          ...
          var p = r.createClass({
            ...
            transition: function (e, t) {
              var r = this.getDOMNode(),
                ...
                p = function (e) {
                  (e && e.target !== r) ||
                    ("production" !== n.env.NODE_ENV && clearTimeout(u),
                    o.removeClass(r, i),
                    o.removeClass(r, s),
              ...
              a.addEndEventListener(r, p),
                o.addClass(r, i),
                this.queueClass(s),
                "production" !== n.env.NODE_ENV && (u = setTimeout(l, c));
            },
          ...
          function o(e, t) {
            ...
            I.hasOwnProperty(t) &&
              ...
              e.hasOwnProperty(t) &&
                ("production" !== n.env.NODE_ENV
                  ? _(
                      r === w.DEFINE_MANY || r === w.DEFINE_MANY_MERGED,
                      "ReactClassInterface: You are attempting to define `%s` on your component more than once. This conflict may be due to a mixin.",
                      t,
                    )
                  : _(r === w.DEFINE_MANY || r === w.DEFINE_MANY_MERGED));
          }
                  ...
                  if ((o(r, a), T.hasOwnProperty(a))) T[a](e, i);
                    ...
                    if (f)
                      ...
                      "production" !== n.env.NODE_ENV
                        ...
                        v === w.DEFINE_MANY_MERGED
                          ? (r[a] = u(r[a], i))
                          : v === w.DEFINE_MANY && (r[a] = c(r[a], i));
                    } else
                      (r[a] = i),
                        "production" !== n.env.NODE_ENV &&
                          "function" == typeof i &&
                          t.displayName &&
                          (r[a].displayName = t.displayName + "_" + a);
                  }
                }
            }
          }
          ...
          function l(e, t) {
            ...
            if ("production" !== n.env.NODE_ENV) {
              ...
              var o = e.constructor.displayName,
                a = r.bind;
              r.bind = function (i) {
                for (var s = [], u = 1, c = arguments.length; c > u; u++)
                  s.push(arguments[u]);
                if (i !== e && null !== i)
                  "production" !== n.env.NODE_ENV
                    ? R(
          ...
          var d = e("./ReactComponent"),
            ...
            T = {
              ...
              childContextTypes: function (e, t) {
                "production" !== n.env.NODE_ENV && r(e, t, g.childContext),
                  (e.childContextTypes = b({}, e.childContextTypes, t));
              },
              contextTypes: function (e, t) {
                "production" !== n.env.NODE_ENV && r(e, t, g.context),
              ...
              propTypes: function (e, t) {
                "production" !== n.env.NODE_ENV && r(e, t, g.prop),
              ...
              var t = function (e, r) {
                ...
                "production" !== n.env.NODE_ENV &&
                  ...
                  "production" !== n.env.NODE_ENV
                    ...
                    : _("object" == typeof o && !Array.isArray(o)),
                  (this.state = o);
              };
              (t.prototype = new S()),
            ...
            N = {
              ...
              mountComponent: function (e, t, r) {
                ...
                void 0 === u && (s.state = u = null),
                  "production" !== n.env.NODE_ENV
                    ...
                    : E("object" == typeof u && !Array.isArray(u)),
                  (this._pendingStateQueue = null),
                  (this._pendingReplaceState = !1),
                  (this._pendingForceUpdate = !1);
                var d,
              ...
              _processContext: function (e) {
                ...
                if ("production" !== n.env.NODE_ENV) {
                  ...
                  r.contextTypes &&
                    this._checkPropTypes(r.contextTypes, t, f.context);
                }
                return t;
              },
              _processChildContext: function (e) {
                ...
                if (r) {
                  "production" !== n.env.NODE_ENV
                    ...
                    : E("object" == typeof t.constructor.childContextTypes),
                    "production" !== n.env.NODE_ENV &&
                  ...
                  for (var o in r)
                    "production" !== n.env.NODE_ENV
                      ...
                      : E(o in t.constructor.childContextTypes);
                  return y({}, e, r);
                }
                return e;
              },
              ...
              performUpdateIfNecessary: function (e) {
                null != this._pendingElement &&
                  ...
                  (null !== this._pendingStateQueue ||
                    ...
                    ("production" !== n.env.NODE_ENV &&
                      u.checkAndWarnForMutatedProps(this._currentElement),
              ...
              updateComponent: function (e, t, r, o, a) {
                ...
                t !== r &&
                  ...
                  "production" !== n.env.NODE_ENV &&
                    null != a &&
                    this._warnIfContextsDiffer(r._context, a),
                ...
                "production" !== n.env.NODE_ENV &&
                  ...
                  l
                    ? ((this._pendingForceUpdate = !1),
                      this._performComponentUpdate(r, u, c, s, e, a))
              ...
              _performComponentUpdate: function (e, t, n, r, o, a) {
                ...
                i.componentWillUpdate && i.componentWillUpdate(t, n, r),
                  ...
                  i.componentDidUpdate &&
                    o
                      .getReactMountReady()
                      .enqueue(i.componentDidUpdate.bind(i, s, u, c), i);
              },
              ...
              _renderValidatedComponent: function () {
                ...
                return (
                  "production" !== n.env.NODE_ENV
                    ...
                    : E(null === e || e === !1 || s.isValidElement(e)),
                  e
                );
              },
            ...
            e &&
              (null != e.dangerouslySetInnerHTML &&
                ...
                "production" !== n.env.NODE_ENV
                  ...
                  : y(null != e.dangerouslySetInnerHTML.__html)),
              "production" !== n.env.NODE_ENV &&
                ("production" !== n.env.NODE_ENV
                  ? C(
                      null == e.innerHTML,
                  ...
                  if (t.hasOwnProperty(r)) {
                    ...
                    if (null != a)
                      if (N.hasOwnProperty(r)) o(this._rootNodeID, r, a, e);
                        ...
                        r === R &&
                          (a && (a = this._previousStyleCopy = v({}, t.style)),
                          (a = s.createMarkupForStyles(a)));
                  ...
                  if (i.hasOwnProperty(n) && c !== l)
                    if (n === R)
                      ...
                      N.hasOwnProperty(n)
                        ...
                        : (u.isStandardName[n] || u.isCustomAttribute(n)) &&
                          w.updatePropertyByID(this._rootNodeID, n, c);
                }
              ...
              _updateDOMChildren: function (e, t, n) {
                ...
                null != u && null == c
                  ...
                  null != a
                    ...
                    : null != s
                      ? i !== s && w.updateInnerHTMLByID(this._rootNodeID, s)
            ...
            m = u.createClass({
              ...
              componentDidUpdate: function () {
                ...
                null != this.props.checked &&
                  a.setValueForProperty(e, "checked", this.props.checked || !1);
                var t = i.getValue(this);
              ...
              _handleChange: function (e) {
                ...
                if ("radio" === this.props.type && null != a) {
                  for (var s = this.getDOMNode(), u = s; u.parentNode; )
                    u = u.parentNode;
                  for (
                    ...
                    if (m !== s && m.form === s.form) {
                      ...
                      var g = v[y];
                      "production" !== n.env.NODE_ENV
                        ? f(g, "ReactDOMInput: Unknown radio button ID %s.", y)
                        : f(g),
                        p.asap(r, g);
                    }
                  }
          ...
          p = {
            ...
            batchedUpdates: function (e, t, n, r, o) {
              ...
              (p.isBatchingUpdates = !0),
                a ? e(t, n, r, o) : l.perform(e, null, t, n, r, o);
            },
          };
        t.exports = p;
      },
          ...
          function o() {
            if (
              ...
              T.RootIndex.injectCreateReactRootIndex(
                l.canUseDOM ? s.createReactRootIndex : A.createReactRootIndex,
              ),
            ...
            for (var p in l)
              if (!t || a[p]) {
                ...
                (n = d.owner + " > " + d.current),
                  ...
                  c.inclusive[p] && (r[n].time += c.inclusive[p]),
              ...
              if (o) {
                if (o !== e.entries)
                  for (var a, u = o.call(e); !(a = u.next()).done; )
                    v.isValidElement(a.value) && i(a.value, t);
            ...
            for (var i in t)
              if (t.hasOwnProperty(i)) {
                ...
                if (s instanceof Error && !(s.message in R)) {
                  ...
                  var c = r(this);
                  "production" !== n.env.NODE_ENV
                    ? N(!1, "Failed propType: %s%s", s.message, c)
                    : null;
                }
              }
          }
          ...
          var v = e("./ReactElement"),
            ...
            M = {
              ...
              cloneElement: function () {
                for (
                  var e = v.cloneElement.apply(this, arguments), t = 2;
                  t < arguments.length;
                  t++
                )
            ...
            Y = {
              ...
              _updateRootComponent: function (e, t, r, a) {
                return (
                  ...
                  "production" !== n.env.NODE_ENV && (q[o(r)] = P(r)),
                  e
                );
              },
              _registerComponent: function (e, t) {
                "production" !== n.env.NODE_ENV
                  ? S(
                      t && (t.nodeType === F || t.nodeType === B),
                      "_registerComponent(...): Target container is not a DOM element.",
                    )
                  : S(t && (t.nodeType === F || t.nodeType === B)),
              ...
              _renderNewRootComponent: function (e, t, r) {
                ...
                return (
                  ...
                  "production" !== n.env.NODE_ENV && (q[a] = P(t)),
                  o
                );
              },
              ...
              unmountComponentAtNode: function (e) {
                ...
                return r
                  ? (Y.unmountComponentFromNode(r, e),
                    delete W[t],
                    delete H[t],
                    "production" !== n.env.NODE_ENV && delete q[t],
                    !0)
                  : !1;
              },
            ...
            o = {
              ...
              removeComponentAsRefFrom: function (e, t, a) {
                "production" !== n.env.NODE_ENV
                  ...
                  : r(o.isValidOwner(a)),
                  a.getPublicInstance().refs[t] === e.getPublicInstance() &&
                    a.detachRef(t);
              },
            };
          t.exports = o;
          ...
          var r = {
            ...
            measureMethods: function (t, n, o) {
              if ("production" !== e.env.NODE_ENV)
                for (var a in o)
                  o.hasOwnProperty(a) && (t[a] = r.measure(n, o[a], t[a]));
            },
          ...
          var o = e("./ReactRef"),
            ...
            i = {
              mountComponent: function (e, t, o, i) {
                ...
                return (
                  "production" !== n.env.NODE_ENV &&
                    a.checkAndWarnForMutatedProps(e._currentElement),
              ...
              receiveComponent: function (e, t, i, s) {
                ...
                if (t !== u || null == t._owner) {
                  ...
                  c && o.detachRefs(e, u),
                    ...
                    c && i.getReactMountReady().enqueue(r, e);
                }
              },
          ...
          return function (t, r) {
            ...
            E(o, r),
              b.isDOMComponent(t)
                ...
                : t.tagName && b.simulateNativeEventOnNode(e, t, o);
          };
        }
        var i = e("./EventConstants"),
          ...
          b = {
            ...
            isCompositeComponentElementWithType: function (e, t) {
              return !(
                !b.isCompositeComponentElement(e) || e.constructor !== t
              );
            },
              ...
              if (b.isDOMComponent(e)) {
                ...
                for (r in a)
                  a.hasOwnProperty(r) &&
                    ...
                    (n = n.concat(
                      b.findAllInRenderedTree(a[r].getPublicInstance(), t),
                    ));
              } else
                b.isCompositeComponent(e) &&
                  (n = n.concat(
                    b.findAllInRenderedTree(
                      b.getRenderedChildOfCompositeComponent(e),
                      t,
                    ),
                  ));
              return n;
        ...
        (function (n) {
          ...
          function s(e) {
            ...
            for (var r = 0; t > r; r++) {
              ...
              if (
                ...
                h.performUpdateIfNecessary(o, e.reconcileTransaction),
                a)
              )
                for (var s = 0; s < a.length; s++)
                  e.callbackQueue.enqueue(a[s], o.getPublicInstance());
            }
          }
          ...
          function u(e) {
            return (
              ...
              "production" !== n.env.NODE_ENV
                ...
                : null,
              _.isBatchingUpdates ? void E.push(e) : void _.batchedUpdates(u, e)
            );
          }
          ...
          var l = e("./CallbackQueue"),
            ...
            N = {
              ...
              close: function () {
                this.dirtyComponentsLength !== E.length
                  ? (E.splice(0, this.dirtyComponentsLength), D())
                  : (E.length = 0);
              },
            },
            O = {
          ...
          var w = {
              ...
              injectBatchingStrategy: function (e) {
                "production" !== n.env.NODE_ENV
                  ? y(e, "ReactUpdates: must provide a batching strategy")
                  : y(e),
                  "production" !== n.env.NODE_ENV
                    ? y(
        ...
        (function (n) {
          ...
          var N = {
            ...
            extractEvents: function (e, t, r, o) {
              ...
              "production" !== n.env.NODE_ENV
                ? m(g, "SimpleEventPlugin: Unhandled event type, `%s`.", e)
                : m(g);
      ...
      function (e, t) {
        (function (n) {
          ...
          function o(e, t) {
            var o = c;
            "production" !== n.env.NODE_ENV
              ? u(!!c, "createNodesFromMarkup dummy not initialized")
              : u(!!c);
            var a = r(e),
              l = a && s(a);
            if (l) {
          ...
          function a(e, t) {
            ...
            t.hasOwnProperty(c) &&
              ...
              t.hasOwnProperty(h) &&
                ...
                (s = t[h](s)));
            for (var g in t)
              (m.hasOwnProperty(g) && m[g]) || (s[g] = a(e[g], t[g]));
            return s;
          }
    ...
    180: [
      function (e, t) {
        (function (n) {
          ...
          function i(e, t, n) {
            return function () {
              for (var r = arguments.length, o = Array(r), a = 0; r > a; a++)
                o[a] = arguments[a];
          ...
          function s(e, t, n) {
            return (
              u(e, t.bind(null, (n = n || (Array.isArray(e) ? [] : {})))), n
            );
          }
          ...
          t.exports = function (e, t, c) {
            function f(e, n) {
              ...
              if (this.props[i]) {
                var u;
                (this._notifying = !0),
                  (u = this.props[i]).call.apply(u, [this, n].concat(o)),
                  (this._notifying = !1);
              }
              return (
                this.setState(
            ...
            return (
              ...
              p.createClass({
                ...
                render: function () {
                  ...
                  return (
                    u(t, function (e, t) {
                      (r[t] = h(n.props, t) ? n.props[t] : n.state[t]),
                        (r[e] = f.bind(n, t));
                    }),
    ...
    182: [
      function (e, t) {
        t.exports = {
          ...
          author:
            "Author of the original beizer-curve-editor, Ga�tan Renaudeau",
          license: "ISC",
          bugs: {
          ...
          r = function (e, t) {
            ...
            if (Symbol.iterator in Object(e)) {
              for (
                ...
                !(n = o.next()).done && (r.push(n.value), !t || r.length !== t);
                ...
                inversey: {
                  value: function (e) {
                    var t = this.props,
                      ...
                      i = n - o[0] - o[2];
                    return (
                      (e = Math.max(a, Math.min(e, n - a))), 1 - (e - o[0]) / i
                    );
                  },
                },
              }),
                ...
                shouldComponentUpdate: {
                  value: function (e) {
                    ...
                    var n = this.props,
                      ...
                      i = n.value;
                    return (
                      e.curveColor !== r || e.curveWidth !== a || e.value !== i
                    );
                  },
                },
                render: {
                ...
                shouldComponentUpdate: {
                  value: function (e) {
                    ...
                    var n = this.props,
                      ...
                      i = n.progressColor;
                    return (
                      e.progress !== a || e.progressColor !== i || e.value !== r
                    );
                  },
                },
                componentWillUpdate: {
